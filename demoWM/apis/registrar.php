...
try {
    ...
    $verificarCorreo = $conex->query("SELECT * FROM usuarioswm WHERE email='$email'");
    $pdo = $conex->prepare("INSERT INTO usuarioswm(razonSocial,rut,telefono,direccion,email,pass) VALUES('$razonSocial','$rut','$tel','$direccion','$email','$pass')");
